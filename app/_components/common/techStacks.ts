import { TechItem } from "../section/TechStack.types";
...
export const techStacks: Record<string, TechItem> = {
  ...
  css: {
    name: "CSS",
    icon: "FaCss3Alt",
    description: "Responsive layouts, custom animations, and utility classes.",
  },
  javascript: {
    name: "JavaScript",
    icon: "SiJavascript",
  ...
  astro: {
    name: "Astro",
    icon: "SiAstro",
    description: "Exploring modern static site generation.",
  },
  graphql: {
    name: "GraphQL",
    icon: "SiGraphql",
    description: "Learning to build flexible APIs.",
  },
  aws: {
    name: "AWS",
    icon: "FaAws",
    description: "Getting hands-on with cloud deployments.",
  },
  asp: {
    name: ".NET",
    icon: "SiDotnet",
